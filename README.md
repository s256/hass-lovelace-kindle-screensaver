...
| `HA_Theme`                | `{"theme":"eink"}`                                | no      | no       |  Define the HA Theme to use (make sure to install it, e.g. [eink](https://github.com/sibbl/hass-lovelace-kindle-screensaver/blob/main/lovelace-eink-theme.yml) )    |
